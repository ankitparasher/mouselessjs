...
var ext = {
        ...
        alertFun: function(){alert("Quick Browse On !!!")},
    		...
    		focusSelectedLink: function(str) {
    			...
    			while ( el && el.tagName != 'A' && el.tagName!='BUTTON' ) el = el.parentNode;
    		...
    		handleNonAlphaKeys: function(e) {
    			...
    			if ( e.character == 'G' && e.cmdKey && ext.selectedTextEqualsNextSearchString() ) {
    				...
    				ext.displayInIndicator(ext.nextSearchString, ' (â–º)');
